<template>
  <div>
    ...
    >
      ...
      >
        <li class="nav-item">
          <a @click="setActiveTab" data-tab="0" class="nav-link active" data-toggle="tab" href="#" role="tab">
            Alerts
          </a>
        </li>
        <li class="nav-item">
          <a @click="setActiveTab" data-tab="1" class="nav-link" data-toggle="tab" href="#" role="tab">
            Events
          </a>
        </li>
        <li class="nav-item">
          <a @click="setActiveTab" data-tab="2" class="nav-link" data-toggle="tab" href="#" role="tab">
            Logs
          </a>
        </li>
      </ul>
      ...
      <b-tab active class="p-8">
        <perfect-scrollbar class="scroll pr-7 mr-n7" style="max-height: 40vh; position: relative;">
          <template v-for="(item, i) in list1">
            <!--begin::Item-->
            <div class="d-flex align-items-center mb-6" :key="i">
              <!--begin::Symbol-->
              <div class="symbol symbol-40 mr-5" :class="`symbol-light-${item.color}`">
                <span class="symbol-label">
                  <span class="svg-icon svg-icon-lg" :class="`svg-icon-${item.color}`">
                    <!--begin::Svg Icon-->
